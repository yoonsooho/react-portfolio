  ...
  let data = [
    {
      ...
      project: project1,
      review:
        "음식 주문 웹사이트로, 원하는 음식을 주문 후 알맞은 정보를 입력하면 form을 통해 전달하는 웹 사이트를 구현하였습니다.",
    },
    {
      id: 2,
      image: IMG2,
      ...
      project: project2,
      review:
        "프론트엔드 개발자 5명, 웹 디자이너 5명과 기업연계 프로젝트를 하여 만든 랜탈 서비스를 하는 웹 사이트 입니다.",
    },
    {
      id: 3,
      image: IMG3,
      ...
      demo: "",
      review:
        "프론트엔드 개발자5명과 협업하여 만든 New York Times Api를 이용한 검색 웹사이트 입니다.",
    },
    {
      id: 4,
      image: IMG4,
